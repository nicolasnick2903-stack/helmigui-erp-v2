...
export default function ClienteDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#0d3d2a]">
      ...
      <a
        href="https://wa.me/5511992144970?text=Olá!%20Preciso%20de%20suporte."
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-40 w-14 h-14 bg-[#25D366] rounded-full shadow-lg shadow-black/40 flex items-center justify-center hover:scale-110 active:scale-95 transition-transform"
